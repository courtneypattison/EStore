...
public class InnerListenerDemo2 extends JFrame
{
    ...
    {
        InnerListenerDemo2 gui = new InnerListenerDemo2( );
        gui.setVisible(true);
    }

    public InnerListenerDemo2( )
    {
        ...
        redChoice.addActionListener(new ActionListener() {
        ...
        blueChoice.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
